import { TabsBtn, TabsContent, TabsProvider } from "../hooks/tabs";

function AnimatedTab() {
  return (
    <div className="border bg-white/10 dark:bg-black/40 backdrop-blur-sm rounded-md p-4  relative mt-20 mb-20">
      <TabsProvider defaultValue={"design"} wobbly={true} hover={false}>
