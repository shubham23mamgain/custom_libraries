...
export default function CreativeScroll() {
  ...
  return (
    <ReactLenis root>
      <main>
        <article>
          <header className="text-white relative bg-slate-950  grid place-content-center  h-[80vh]">
          ...
          <section className="h-[500vh] w- relative">
            <ul ref={ulRef} className="flex bg-pink-500 sticky top-0">
              <li className="h-screen w-[100%] bg-red-400 flex flex-col justify-center overflow-hidden  items-center">
